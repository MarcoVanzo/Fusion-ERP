...
const Website = (() => {
    ...
    function _renderNewsList() {
            ...
            <div class="table-responsive">
                ...
                : '<span class="badge badge-warning">Bozza</span>'}
                                ...
                                <td style="text-align: right;">
                                    <button class="btn btn-ghost btn-icon btn-sm news-edit-btn" data-id="${n.id}" title="Modifica">
        ...
        // Event delegation: evita onclick inline nel template HTML
        listEl.querySelectorAll('.news-edit-btn').forEach(btn => {
