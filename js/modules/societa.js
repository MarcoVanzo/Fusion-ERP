...
const Societa = (() => {
    ...
    ((e.innerHTML = `
            <div>
                <div style="display:flex;align-items:center;justify-content:space-between;gap:var(--sp-2);margin-bottom:var(--sp-3);flex-wrap:wrap">
                    ...
                    ${t ? '<button class="btn-dash pink" id="soc-add-deadline" type="button"><i class="ph ph-plus"></i> NUOVA SCADENZA</button>' : ""}
                </div>
                        ...
                        : s
                            ...
                            <div class="dash-card" style="padding:var(--sp-3);display:flex;align-items:center;gap:var(--sp-3);flex-wrap:wrap" data-dl-status="${Utils.escapeHtml(e.status)}">
                                ...
                                <div style="display:flex;gap:4px">
                                    <button class="btn-dash" data-edit-dl="${Utils.escapeHtml(e.id)}" type="button"><i class="ph ph-pencil-simple"></i></button>
                                    <button class="btn-dash" data-del-dl="${Utils.escapeHtml(e.id)}" type="button" style="color:var(--color-pink)"><i class="ph ph-trash"></i></button>
                                </div>`
                                    : ""
                                }
                            </div>`;
    ...
    const t = !!e,
      a = UI.modal({
        ...
        footer: `
                ...
                <button class="btn-dash pink" id="dl-save" type="button">${t ? "SALVA" : "CREA"}</button>`,
      });
    (document
  ...
  function openTitoloModal(titolo) {
    ...
    const modal = UI.modal({
      ...
      footer: `
            <button class="btn-dash" id="tt-cancel" type="button">Annulla</button>
            <button class="btn-dash pink" id="tt-save" type="button">${isEdit ? "SALVA" : "CREA TITOLO"}</button>`,
    });
    document
      ...
      <div class="dash-card" style="padding:var(--sp-4)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--sp-3)">
          <div>
            ...
            ${isAdmin ? '<button class="btn-dash pink" id="for-save-desc" type="button"><i class="ph ph-floppy-disk"></i> SALVA DESCRIZIONE</button>' : ""}
          </div>
          <div>
