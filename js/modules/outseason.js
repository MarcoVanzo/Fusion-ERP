...
const OutSeason = (() => {
  ...
  function v() {
    const n = [...e].sort((n, t) => {
      ...
      return e !== o
        ? e - o
        : new Date(n.entry_date || 0) - new Date(t.entry_date || 0);
    }),
      o = n.filter((n) => r(n) || t.has(c(n))),
      a = n.filter((n) => !r(n) && !t.has(c(n))),
      s = n
        .map(
          (n, e) =>
            `\n            <tr>\n                <td style="opacity:.5;">${e + 1}</td>\n                <td style="font-weight:600;">${c(n)}</td>\n                <td>${g(n)}</td>\n                <td><span class="os-badge-formula ${d(n) ? "os-badge-full" : "os-badge-daily"}">${b(n)}</span></td>\n                <td style="font-weight:600;">${(function (
              ...
              return d(n) ? "250 €" : "150 €";
            })(n)}</td>\n                <td>${"Bonifico Bancario" ===
              (function (n) {
                return n.come_vuoi_pagare || n.ComeVuoiPagare || "";
              })(n)
              ? "🏦 Bonifico"
              : "💳 Carta/PayPal"
            }</td>\n                <td>${r(n) || t.has(c(n)) ? '<span class="os-badge-paid">● Pagato</span>' : '<span class="os-badge-unpaid">● Da pagare</span>'}</td>\n                <td style="opacity:.7;">${(function (
              n,
            ) {
              ...
              n,
            )}</td>\n                <td style="opacity:.5;font-size:11px;">${(function (n) {
