...
const OutSeason = (() => {
  ...
  function K() {
    ...
    return `<div class="os-kpi"><div class="os-kpi-label">Totale Iscritte</div><div class="os-kpi-value total">${e.length}</div></div><div class="os-kpi"><div class="os-kpi-label">Caparra Incassata</div><div class="os-kpi-value paid">${z.toLocaleString("it-IT")} €</div></div><div class="os-kpi"><div class="os-kpi-label">Caparra Da Riscuotere</div><div class="os-kpi-value unpaid">${$.toLocaleString("it-IT")} €</div></div><div class="os-kpi"><div class="os-kpi-label">Totale Caparre</div><div class="os-kpi-value" style="color:#818cf8;">${k.toLocaleString("it-IT")} €</div></div>${(function(){ const saldoTot = e.reduce((acc, x) => { const s = getSaldo(x); return s !== null ? acc + s : acc; }, 0); const cnt = e.filter(x => getSaldo(x) !== null).length; return cnt > 0 ? '<div class="os-kpi"><div class="os-kpi-label">Saldo Residuo</div><div class="os-kpi-value" style="color:#f59e0b;">' + saldoTot.toLocaleString('it-IT') + ' €</div></div>' : ''; })()}`;
  }
  function w(n) {
