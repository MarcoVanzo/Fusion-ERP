        ...
        return `
            <div class="st-card" style="cursor:default;">
                ...
                <div style="margin-top:12px; padding-top:12px; border-top:1px dashed rgba(255,255,255,0.1);">
                    ...
                    <button class="btn-dash btn-duplicate-transport" data-transport-id="${Utils.escapeHtml(tr.id)}" type="button" style="padding:8px 16px; font-size:11px; border-color:var(--accent-cyan); color:var(--accent-cyan);">
                        <i class="ph ph-copy" style="font-size:16px;"></i> DUPLICA
                    </button>
