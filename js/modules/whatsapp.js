            ...
            try {
              ...
              if (c.length > a.length) {
                ...
                const t = document.getElementById("wa-messages"),
                  e =
                    !(s = t) ||
                    s.scrollHeight - s.scrollTop - s.clientHeight < 60;
                (o(t), e && p(t), (i = 5e3));
              } else i = Math.min(1.5 * i, 6e4);
            } catch {
              i = Math.min(1.5 * i, 6e4);
            }
            var s;
            n === e &&
              c.active &&
                            ...
                            (function (t) {
                              const e = t.name
                                ...
                                n = t.athlete_name
                                  ...
                                  : `<button class="btn-dash btn-link-athlete" data-contact-id="${Utils.escapeHtml(t.id)}" type="button">\n                   <i class="ph ph-link"></i> Collega atleta\n               </button>`;
