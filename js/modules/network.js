...
const Network = (() => {
  ...
  function b(t) {
    ...
    ((t.innerHTML = `\n            <div>
                ${hubBanner}\n                <div class="net-filter-bar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--sp-2);margin-bottom:var(--sp-3)">\n                    <div style="display:flex;gap:var(--sp-1);flex-wrap:wrap">\n                        <button class="dash-filter ${o ? "" : "active"}" data-col-status="" type="button">Tutte</button>\n                        ${r.map((t) => `\n                            <button class="dash-filter ${o === t ? "active" : ""}" data-col-status="${Utils.escapeHtml(t)}" type="button">\n                                ${Utils.escapeHtml(p[t] || t)}\n                            </button>`).join("")}\n                    </div>\n                    ${e ? '<button class="btn-dash pink" id="net-add-col" type="button"><i class="ph ph-plus"></i> NUOVA COLLABORAZIONE</button>' : ""}\n                </div>\n                <div class="net-card-grid">\n                    ${
                  0 === n.length
                    ? Utils.emptyState(
                    ...
                    : n
                        .map(
                          (
                            t,
                          ) => `\n                            <div class="dash-card" data-open-col="${Utils.escapeHtml(t.id)}">\n                                <div class="net-card-header">
            ...
            n &&
              (function (t) {
                const e = UI.modal({
                  ...
                  footer:
                    '<button class="btn-dash" id="cod-close" type="button">Chiudi</button>',
                });
            ...
            (e.stopPropagation(),
              (async function (t) {
                ...
                const n = UI.modal({
                  ...
                  footer:
                    '<button class="btn-dash" id="dc-cancel" type="button">Annulla</button>\n                     <button class="btn-dash pink" id="dc-confirm" type="button" style="background:var(--color-pink)">ELIMINA</button>',
                });
                (document
            ...
            (function (t) {
              const e = [
                ...
                a = UI.modal({
                  ...
                  footer:
                    '\n                <button class="btn-dash" id="ev-cancel" type="button">Annulla</button>\n                <button class="btn-dash pink" id="ev-save" type="button"><i class="ph ph-star"></i> SALVA VALUTAZIONE</button>',
                });
              (e.forEach((t) => {
          ...
          () =>
            (async function (t) {
              ...
              const a = UI.modal({
                ...
                footer:
                  '<button class="btn-dash" id="dt-cancel" type="button">Annulla</button>\n                     <button class="btn-dash pink" id="dt-confirm" type="button" style="background:var(--color-pink)">RIMUOVI</button>',
              });
              (document
  ...
  function y(t) {
    const e = !!t,
      ...
      l = UI.modal({
        ...
        footer: `\n                <button class="btn-dash" id="tr-cancel" type="button">Annulla</button>\n                <button class="btn-dash pink" id="tr-save" type="button">${e ? "SALVA" : "CREA"}</button>`,
      });
    (document
  ...
  function x(t) {
    const e = !!t,
      a = UI.modal({
        ...
        footer: `\n                <button class="btn-dash" id="ac-cancel" type="button">Annulla</button>\n                <button class="btn-dash pink" id="ac-save" type="button">${e ? "SALVA" : "CREA"}</button>`,
      });
    (document
