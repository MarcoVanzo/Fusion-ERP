...
const Admin = (() => {
  ...
  const g = ["admin", "manager", "allenatore", "operatore", "atleta"],
    b = {
      admin: "Admin",
      manager: "Manager",
        ...
        Utils.qsa(".user-edit-role").forEach((e) =>
          e.addEventListener(
            ...
            () => {
              !(function (e) {
                const n = UI.modal({
                  title: `Modifica ruolo — ${Utils.escapeHtml(e.full_name)}`,
                ...
                (document
                  ...
                  document.getElementById("er-save")?.addEventListener(
                    ...
                    () =>
                      (async function (t, e) {
                        const n = document.getElementById("er-role").value,
                          a = document.getElementById("er-error"),
              ...
              !(async function (t, e) {
                if (
                  ...
                  try {
                    ...
                    (UI.toast(`Utente ${e} eliminato.`, "success"), await v());
                  } catch (t) {
                    UI.toast("Errore: " + t.message, "error");
                  }
              })(e.dataset.uid, e.dataset.name);
