          ...
          (function () {
            ...
            const l = {},
              ...
              o = () => {
                document
                  .querySelectorAll(
                    "#staff-wizard-body input, #staff-wizard-body select, #staff-wizard-body textarea",
                  )
                  .forEach((e) => {
                    l[e.id] = e.value;
                  });
  ...
  return {
    ...
    async init() {
      ...
      if (e) {
        ...
        try {
          ((t = await Store.get("list", "staff")), (n = null), i());
        } catch (t) {
