              ...
              (document
                ...
                document
                  ...
                  ?.addEventListener("click", async () => {
                    ...
                    const wrapper = document.getElementById("es-teams-wrapper");
                    const checkedTeams = wrapper ? Array.from(wrapper.querySelectorAll('input[name="es-teams"]:checked')).map(el => el.value) : [];
