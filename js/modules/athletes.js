            ...
            try {
              const s = n ? { team_id: n } : {},
                ...
                v = (e, t) => {
                  ...
                  const a = e[t];
                  return `<span style="font-weight:600;">${u(a.value)}</span><span style="font-size:10px;color:var(--color-text-muted);margin-left:2px;">${Utils.escapeHtml(a.unit)}</span>`;
                },
                y = Array.isArray(a) ? a : [],
