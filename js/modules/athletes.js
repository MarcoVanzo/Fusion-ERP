                ...
                async () => {
                  ...
                  try {
                    (await AthletesAPI.create({
                      ...
                      (t = await AthletesAPI.getLightList().catch(() => t)),
                      (s = "anagrafica"),
                      p.close(),
    ...
    if (n) {
      ...
      try {
        const [r, o, c] = await Promise.all([
            ...
            Store.get("getPlan", "payments", { id: n })
              .then((res) => (res ? res.installments || [] : []))
              .catch(() => []),
        ...
        w &&
          (w.onchange = async () => {
            ...
            try {
              ...
              if (!l || !l.success)
                throw new Error(l.error || l.message || "Errore upload");
              (t &&
              ...
              (async function (e) {
                ...
                if (t) {
                  ...
                  try {
                    ...
                    const bestJumpEl = document.getElementById(
                      "athlete-best-jump-val",
                    );
    ...
    if (document.querySelector("script[data-gmaps-places]")) {
      const pollInterval = setInterval(() => {
        "undefined" != typeof google &&
          ...
          (_activeIntervals = _activeIntervals.filter(
            (i) => i !== pollInterval,
          )),
          w(),
          callback());
...
// window.__valdAi and window.__valdChat have been abstracted into js/modules/athletes/ValdAI.js
