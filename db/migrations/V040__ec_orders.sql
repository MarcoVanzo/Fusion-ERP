CREATE TABLE IF NOT EXISTS ec_orders (
    ...
    stato_forms ENUM('da definire', 'pagato', 'non pagato', 'consegnato') DEFAULT 'da definire',
    stato_interno ENUM('da definire', 'pagato', 'non pagato', 'consegnato') DEFAULT 'da definire',
