                        ...
                        {videos.map(video => {
                            ...
                            return (
                                <div key={video.id} className="w-full relative bg-black aspect-video max-h-[85vh] overflow-hidden group border-y border-zinc-800">
                                    ...
                                    {video.title && (
                                        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-end justify-center">
