        ...
        <div className="min-h-screen bg-zinc-950 pb-20 overflow-hidden">
            ...
            <div className="relative pt-32 pb-32 border-b border-brand-500/10">
                <div
                    ...
                    style={{ backgroundImage: `url('${import.meta.env.BASE_URL}assets/hero-1.jpg')`, filter: "brightness(0.6) saturate(1.2)" }}
                />
                <div className="absolute inset-0 bg-gradient-to-b from-zinc-950 via-zinc-950/30 to-zinc-950 z-10"></div>
