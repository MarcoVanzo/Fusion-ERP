...
const OpenDay = () => {
    ...
    /* ── Shared input class ─────────── */
    const inputCls = "w-full bg-zinc-950/50 border border-zinc-800 rounded-2xl px-5 py-4 text-white focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 transition-all font-sans placeholder:text-zinc-600";
    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex flex-col lg:flex-row relative overflow-hidden">
            ...
            <div className="w-full lg:w-[45%] relative min-h-[50vh] lg:min-h-screen flex flex-col justify-end lg:justify-center p-8 lg:p-16 xl:p-24 pt-32 shrink-0">
                ...
                >
                    <div className="w-16 h-1 bg-emerald-500 mb-8 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.8)]"></div>
                    <h1 className="font-heading text-5xl md:text-7xl xl:text-8xl text-white uppercase tracking-tighter leading-[0.9]">
                        OPEN <br/>
                        <span className="text-emerald-400 drop-shadow-[0_0_20px_rgba(16,185,129,0.5)]">DAY</span>
                    </h1>
            ...
            {/* ═══ RIGHT — Form ═══ */}
            <div className="w-full lg:w-[55%] flex items-start lg:items-center justify-center p-6 sm:p-10 lg:p-16 relative z-10 bg-zinc-950 lg:bg-transparent -mt-10 lg:mt-0 rounded-t-[40px] lg:rounded-none shadow-[0_-20px_40px_rgba(0,0,0,0.5)] lg:shadow-none overflow-y-auto max-h-screen">
                <div className="w-full max-w-xl py-8 lg:py-4">
                    <AnimatePresence mode="wait">
                        {success ? (
                            <motion.div
                                ...
                                className="bg-zinc-900/40 border border-emerald-500/30 p-10 md:p-14 rounded-[2rem] text-center backdrop-blur-xl relative overflow-hidden"
                            >
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/80 p-8 md:p-10 rounded-[2rem] space-y-6 shadow-2xl relative overflow-hidden hover:border-zinc-700 transition-colors duration-500">
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-emerald-500/30 to-transparent"></div>
                                    ...
                                    {/* Dati Atleta */}
                                    <p className="text-emerald-400 text-xs font-heading tracking-[0.2em] uppercase border-b border-zinc-800 pb-2">Dati dell'Atleta</p>
                                    ...
                                    {/* Esperienza Sportiva */}
                                    <p className="text-emerald-400 text-xs font-heading tracking-[0.2em] uppercase border-b border-zinc-800 pb-2 mt-4">Esperienza Sportiva</p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div className="space-y-2">
                                    ...
                                    {/* Genitore */}
                                    <p className="text-emerald-400 text-xs font-heading tracking-[0.2em] uppercase border-b border-zinc-800 pb-2 mt-4">Genitore / Tutore</p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div className="space-y-2">
                                    ...
                                    <div className="flex items-start gap-3 mt-4 bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-4">
                                        <input
                                            ...
                                            className="mt-1 w-5 h-5 rounded accent-emerald-500 cursor-pointer shrink-0"
                                        />
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-400 bg-[length:200%_auto] hover:bg-right hover:scale-[1.02] text-white rounded-2xl py-5 font-heading text-xl uppercase tracking-widest transition-all duration-500 shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_40px_rgba(16,185,129,0.6),inset_0_0_15px_rgba(255,255,255,0.4)] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:bg-left flex items-center justify-center gap-3 relative overflow-hidden group border border-emerald-400/30 font-bold"
                                    >
