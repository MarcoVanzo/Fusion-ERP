        ...
        <div className="flex flex-col min-h-screen pb-24 bg-zinc-950">
            ...
            <section className="relative h-[40vh] min-h-[350px] flex items-center justify-center overflow-hidden mb-12">
                ...
                <div
                    ...
                    style={{ backgroundImage: `url('${import.meta.env.BASE_URL}assets/Gemini_Generated_Image_lj3yntlj3yntlj3y.jpeg')`, filter: "brightness(1)" }}
                />

                {/* Overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/10 to-transparent z-10"></div>
