            ...
            <div className="max-w-[1400px] mx-auto px-4 -mt-16 relative z-20">
                ...
                <div className="mb-24">
                    ...
                    {(() => {
                        ...
                        const teamPhoto = isU13 ? '/demo/assets/squadra-u13.jpeg' : isU14 ? '/demo/assets/squadra-u14.jpeg' : isU16 ? '/demo/assets/squadra-u16.jpeg' : isU18 ? '/demo/assets/squadra-u18.jpeg' : null;
